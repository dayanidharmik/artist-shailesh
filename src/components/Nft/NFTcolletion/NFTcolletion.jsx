  ...
  return (
    <>
      ...
      >
        ...
        <p className="font-Roboto text-center text-[#595959] text-xl max-w-6xl mx-auto">
        ...
        {/*  */}
        <div className="font-Roboto gap-16   flex justify-center flex-wrap">
          {team.map((items, key) => (
